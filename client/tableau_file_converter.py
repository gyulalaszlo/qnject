...
class TableauFileConverter(object):

    @staticmethod
    def twbxFromTdeAndTds(tdeFile, tdsFile):
        twbx = 'valami.twbx'
        return twbx
    ...
    @staticmethod
    def twbxToTdsx(twbxDir, twbxFileName, tdsxTempDir, tdsxFile):
    ...
    def createTwbFromTds(twb, tds, path, tde):
        emptywbxmlstr = openfile(twb)
        tdsxmlstr = openfile(tds)
